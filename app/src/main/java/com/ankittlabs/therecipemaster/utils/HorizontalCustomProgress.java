...
public class HorizontalCustomProgress extends View {
    ...
    public HorizontalCustomProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalCustomProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public HorizontalCustomProgress(Context context) {
        super(context);
    }
